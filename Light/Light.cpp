...
int main(int argc, char* argv)
{
  ...
  glutCreateWindow("Lab Assesment 3");		//set window title
...
void renderTxt()
{
	...
	glPushMatrix();
    glLoadIdentity();
	   printBmpStr(10, 10, 1.0f, 0.0f, 0.0f, getFPS(), GLUT_BITMAP_8_BY_13);
	   printBmpStr(10, 20, 1.0f, 0.0f, 0.0f, "0 - toggle help menu on/off", GLUT_BITMAP_8_BY_13);
       if(menuIsOn)
       {
          printBmpStr(10, 30, 1.0f, 0.0f, 0.0f, "up, down, left, right - moves camera up, down, left, right.", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 40, 1.0f, 0.0f, 0.0f, "page up - zoom in, page down - zoom out", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 50, 1.0f, 0.0f, 0.0f, "home - reset view", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 60, 1.0f, 0.0f, 0.0f, "+[plus]- increase global ambient", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 70, 1.0f, 0.0f, 0.0f, "-[minus] - decrease global ambient", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 80, 1.0f, 0.0f, 0.0f, "1 and 2 - toggle left and right lights on/off", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 90, 1.0f, 0.0f, 0.0f, "3 - toggle swinging spotlight on/off", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 100, 1.0f, 0.0f, 0.0f, "4 - increase spotlight swing", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 120, 1.0f, 0.0f, 0.0f, "5 - toggle disco lights on/off", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 130, 1.0f, 0.0f, 0.0f, "6 - increase spotlight swing", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 140, 1.0f, 0.0f, 0.0f, "7 - toggle color tracking on/off", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 150, 1.0f, 0.0f, 0.0f, "8 - toggle smooth and flat shading", GLUT_BITMAP_8_BY_13);
	      printBmpStr(10, 160, 1.0f, 0.0f, 0.0f, "9 - toggle wireframe mode on/off", GLUT_BITMAP_8_BY_13);
          printBmpStr(10, 170, 1.0f, 0.0f, 0.0f,"a - exit program", GLUT_BITMAP_8_BY_13);
       }
...
void setSpKey(int key, int x, int y)
{
  ...
  {
     //if home pressed
    case GLUT_KEY_HOME: for(int i = 0; i < 3; i++)
                           cAngle[i] = 0.0f;
                        cPos[2] = 30.0f;
    break;         
    //if page up pressed
